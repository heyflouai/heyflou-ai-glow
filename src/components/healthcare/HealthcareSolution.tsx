  ...
  const solutions = [
    {
      ...
      titleKey: 'solutionSchedulingTitle',
      descKey: 'solutionSchedulingDesc',
    ...
    },
    {
      ...
      titleKey: 'solutionFollowUpsTitle',
      descKey: 'solutionFollowUpsDesc',
      className: "md:col-span-1",
    },
    {
      icon: <MessageSquare className="h-6 w-6 text-hf-teal" />,
      titleKey: 'solutionPaymentsTitle',
      descKey: 'solutionPaymentsDesc',
      className: "md:col-span-2",
    },
    {
    ...
    },
    {
      ...
      titleKey: 'solutionReportsTitle',
      descKey: 'solutionReportsDesc',
      className: "md:col-span-2",
    },
  ];
