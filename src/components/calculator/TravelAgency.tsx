  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center mb-6">
        <h2 className="text-2xl font-bold text-foreground">{t.calculator.travelAgency}</h2>
        <p className="text-muted-foreground mt-1">{t.calculator.automationSolutionsFor} {t.calculator.travelAgencies}</p>
      </div>
