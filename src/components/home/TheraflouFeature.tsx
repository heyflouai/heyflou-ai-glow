  ...
  return (
    <section className="relative py-10 md:py-14 lg:py-20 overflow-hidden">
      ...
      <div className="service-container mx-auto px-5 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-[60fr_40fr] gap-8 lg:gap-12 items-center">
          {/* Left: copy */}
          <motion.div
          ...
          >
            <p className="text-xs md:text-sm font-semibold uppercase tracking-[0.2em] text-hf-teal mb-3">
              {tf.theraflouEyebrow}
            </p>
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-bold font-display text-foreground leading-tight mb-4">
              {tf.theraflouTitle}
            </h2>
            ...
            <ul className="space-y-2.5 mb-5">
              {features.map((f, i) => (
                <li key={i} className="flex gap-3 items-start">
                  <span className="shrink-0 mt-0.5 inline-flex items-center justify-center w-8 h-8 rounded-lg bg-hf-teal/10 border border-hf-teal/30">
                    <f.icon className="w-3.5 h-3.5 text-hf-teal" />
                  </span>
            ...
            <p className="text-sm md:text-base font-medium text-foreground/95 italic border-l-2 border-hf-teal pl-4 mb-5 max-w-2xl">
              {tf.theraflouProof}
            </p>
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-foreground border border-hf-teal/50 rounded-full transition-all duration-300 hover:border-hf-teal hover:bg-hf-teal/5 hover:shadow-[0_0_20px_rgba(6,182,212,0.25)]"
            >
              {tf.theraflouCta}
          ...
          <motion.div
            ...
            className="relative"
          >
            <div className="relative rounded-2xl border border-hf-teal/30 bg-card/80 backdrop-blur p-5 md:p-6 shadow-[0_20px_60px_-20px_rgba(6,182,212,0.25)]">
              <div className="flex items-center justify-between mb-4 pb-4 border-b border-border/60">
                <div className="flex items-center gap-3">
                  <img src={theraflouMark} alt="TheraFlou" className="h-9 w-auto" />
                  <div>
                    <p className="text-sm font-semibold text-foreground leading-tight">TheraFlou</p>
              ...
              <div className="space-y-2">
                {features.map((f, i) => (
                  <div
                    key={i}
                    className="flex items-center gap-3 p-2.5 rounded-lg bg-background/60 border border-border/50 hover:border-hf-teal/40 transition-colors"
                  >
                    <span className="shrink-0 inline-flex items-center justify-center w-7 h-7 rounded-md bg-hf-teal/10">
                      <f.icon className="w-3.5 h-3.5 text-hf-teal" />
                    </span>
