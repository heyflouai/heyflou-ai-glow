export const en = {
  ...
  // Case Studies Page
  caseStudies: {
    heroTitle: 'Real Results from Real Businesses',
    heroSubtitle: 'See how travel agencies and healthcare practices grow with AI marketing automation.',
    challenge: 'Challenge:',
    solution: 'Solution:',
    outcome: 'Outcome:',
    ...
    // Use case labels
    useCaseMarketingAutomation: 'Marketing Automation',
    useCaseAiChatbot: 'AI Chatbot',
    useCasePatientAcquisition: 'Patient Acquisition',
    useCaseHighTicketSales: 'High-Ticket Sales',
    useCaseCostReduction: 'Cost Reduction',
    useCaseLeadReengagement: 'Lead Re-engagement',
    useCaseMarketingRoi: 'Marketing ROI',
    useCaseContentMarketing: 'Content Marketing',
    
    // Metrics
    metrics62MoreBookings: '62% more bookings',
    metricsFullyAutomatedFunnel: 'Fully automated funnel',
    metrics3xMoreLeads: '3× more leads',
    metricsAiWhatsappPromos: 'AI + WhatsApp promos',
    metrics95MoreClients: '95% more clients',
    metricsConsistentGrowth: 'Consistent growth',
    metrics53MoreHighTicketSales: '53% more high-ticket sales',
    metricsAutomatedNurturing: 'Automated nurturing',
    metrics37LowerCosts: '37% lower costs',
    metricsSameBookings: 'Same bookings',
    metrics31MoreSales: '31% more sales',
    metricsColdLeadsRevived: 'Cold leads revived',
    metrics3xMarketingRoi: '3× marketing ROI',
    metricsClearAttribution: 'Clear attribution',
    metrics2xMoreInquiries: '2× more inquiries',
    metricsContentChatbot: 'Content + chatbot',
    
    // Tags
    tagMarketingFunnel: 'Marketing Funnel',
    tagTravel: 'Travel',
    tagAutomation: 'Automation',
    tagAiChatbot: 'AI Chatbot',
    tagWhatsApp: 'WhatsApp',
    tagLeadGen: 'Lead Gen',
    tagHealthcare: 'Healthcare',
    tagMarketing: 'Marketing',
    tagLuxuryTravel: 'Luxury Travel',
    tagSales: 'Sales',
    tagStudentTravel: 'Student Travel',
    tagAnalytics: 'Analytics',
    tagOptimization: 'Optimization',
    tagCruise: 'Cruise',
    tagReengagement: 'Re-engagement',
    tagRoi: 'ROI',
    tagTherapist: 'Therapist',
    tagContent: 'Content',
    tagChatbot: 'Chatbot',
  },
