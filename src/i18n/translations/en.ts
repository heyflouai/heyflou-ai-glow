export const en = {
  ...
  about: {
    ...
    pillar2Title: 'Bilingual & Bicultural',
    pillar2Desc: 'Full support in English and Spanish. We understand both the traditional SMB culture and cutting-edge tech—because we\'ve lived in both worlds.',
