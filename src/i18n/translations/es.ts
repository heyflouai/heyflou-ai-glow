...
export const es: TranslationKeys = {
  ...
  caseStudies: {
    ...
    // Industry labels
    industryTravel: 'Viajes',
    industryHealthcare: 'Salud',
    
    // Use case labels
    useCaseMarketingAutomation: 'Automatización de Marketing',
    useCaseAiChatbot: 'Chatbot con IA',
    useCasePatientAcquisition: 'Captación de Pacientes',
    useCaseHighTicketSales: 'Ventas de Alto Valor',
    useCaseCostReduction: 'Reducción de Costos',
    useCaseLeadReengagement: 'Re-engagement de Leads',
    useCaseMarketingRoi: 'ROI de Marketing',
    useCaseContentMarketing: 'Marketing de Contenidos',
    
    // Metrics
    metrics62MoreBookings: '62% más reservas',
    metricsFullyAutomatedFunnel: 'Embudo totalmente automatizado',
    metrics3xMoreLeads: '3× más leads',
    metricsAiWhatsappPromos: 'IA + Promos WhatsApp',
    metrics95MoreClients: '95% más clientes',
    metricsConsistentGrowth: 'Crecimiento constante',
    metrics53MoreHighTicketSales: '53% más ventas premium',
    metricsAutomatedNurturing: 'Nurturing automatizado',
    metrics37LowerCosts: '37% menos costos',
    metricsSameBookings: 'Mismas reservas',
    metrics31MoreSales: '31% más ventas',
    metricsColdLeadsRevived: 'Leads fríos reactivados',
    metrics3xMarketingRoi: '3× ROI de marketing',
    metricsClearAttribution: 'Atribución clara',
    metrics2xMoreInquiries: '2× más consultas',
    metricsContentChatbot: 'Contenido + chatbot',
    
    // Tags
    tagMarketingFunnel: 'Embudo de Marketing',
    tagTravel: 'Viajes',
    tagAutomation: 'Automatización',
    tagAiChatbot: 'Chatbot IA',
    tagWhatsApp: 'WhatsApp',
    tagLeadGen: 'Generación de Leads',
    tagHealthcare: 'Salud',
    tagMarketing: 'Marketing',
    tagLuxuryTravel: 'Viajes de Lujo',
    tagSales: 'Ventas',
    tagStudentTravel: 'Viajes Estudiantiles',
    tagAnalytics: 'Analíticas',
    tagOptimization: 'Optimización',
    tagCruise: 'Cruceros',
    tagReengagement: 'Re-engagement',
    tagRoi: 'ROI',
    tagTherapist: 'Terapeuta',
    tagContent: 'Contenido',
    tagChatbot: 'Chatbot',
  },
