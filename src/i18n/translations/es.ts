...
export const es: TranslationKeys = {
  ...
  aboutV2: {
    ...
    mapTitle: 'Construido en Israel. Entregado en México.',
    mapSubtitle: 'Un equipo entre dos continentes, una misión: hacer que la IA empresarial sea alcanzable para todos los demás.',
    mapTelAviv: 'Tel Aviv',
