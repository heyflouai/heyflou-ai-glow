...
export const es: TranslationKeys = {
  ...
  about: {
    ...
    timeline1Detail: '→ Tu inversión: 2 horas  |  Entregamos: Hoja de ruta personalizada',
    ...
    timeline2Detail: '→ Tu inversión: 3 horas de retroalimentación  |  Entregamos: Prototipo funcional',
    ...
    timeline3Detail: '→ Tu inversión: 1 hora de capacitación  |  Entregamos: Sistema completamente integrado',
    ...
    timeline4Detail: '→ Tu inversión: Retroalimentación ligera continua  |  Entregamos: Optimización continua',
