...
export const es: TranslationKeys = {
  ...
  home: {
    ...
    faq2A: 'Diseñamos cada sistema con cumplimiento HIPAA y minimización de datos en mente. Los datos de tus clientes permanecen en tus herramientas — nosotros conectamos sistemas, no almacenamos datos. Todas las integraciones usan conexiones encriptadas y acceso basado en roles.',
  ...
  servicesPage: {
    ...
    v2Card2Eyebrow: 'Para constructores de industria',
    v2Card2Title: 'Una plataforma de IA a medida construida para tu vertical',
    v2Card2Desc: 'Cuando tu industria necesita más que integraciones — diseñamos y construimos el sistema completo. CRMs, plataformas de gestión de pacientes, motores de reservas, capas de cumplimiento. Construimos TheraFlou para fisioterapeutas en México. Podemos hacer lo mismo en la tuya.',
